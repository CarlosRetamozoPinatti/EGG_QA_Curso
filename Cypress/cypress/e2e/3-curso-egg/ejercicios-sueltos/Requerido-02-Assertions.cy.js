describe('Validaciones', () => {
  ...
  //-----------------------------------------------------------------------------
    ...
    it('Usuario Valido', () => {
      ...
      cy.get('#g4072-gender > .ui-selectmenu-text').should('have.value', 'Female');
      ...
      cy.get('#g4072-qatools-button > .ui-selectmenu-text').should('have.value', 'Cypress');
    ...
    it.only('Usuario Vacio', () => { 
      ...
      cy.get('input[name="g4072-phonenumber"]').should('have.value', '0303456');
       ...
       cy.get('.ui-menu-item').contains('Female').click();
       cy.get('#g4072-gender').should('have.value', 'Female');
         
       // Aserción: Verificar que se haya seleccionado el género correctamente
       //cy.get('#g4072-gender > .ui-menu-text').should('have.value', 'Female');
      ...
      // Busco el campo herramientas de testeo y selecciono una opcion
      cy.get('#g4072-qatools-button').click();
      cy.get('.ui-menu-item').contains('Cypress').click();
